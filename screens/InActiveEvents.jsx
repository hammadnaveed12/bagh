    ...
    <View>
      ...
      <SafeAreaView>
        <View style={styles.container}>
          ...
          <Text style={{ color: "black", textAlign: "center", fontSize: 24, fontWeight: "700", marginVertical: 15 }}>List Of Upcoming Events</Text>
          ...
          <View>
            {events.map((event, index) => {
             ...
             <TouchableOpacity  key={index} style={{ padding: 15 ,marginBottom: 10,borderRadius:10,backgroundColor:"#fc4f00"}}>
                <View >
